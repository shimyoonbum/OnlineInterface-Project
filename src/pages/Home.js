            ...
            loginService.getSession().then(data => {
                ...
                if(data.role == "A"){
                    ...
                    commonService.getMainInfo().then(data => {                                                           
                        ...
                        document.getElementById("success").innerHTML = basicData.datasets[0].data[6] + ' 회';    
                        document.getElementById("fail").innerHTML = basicData.datasets[1].data[6] + ' 회'; 
                    });
                }else{
        ...
        <>
            <Card className="mainChart">
                ...
                <div className="content">
                    <Chart className="chart" id="main" type="bar" data={basicData}/>
